...
namespace ElProApp.Data.Migrations
{
    ...
    [Migration("20260108174957_ADdUnitePriceInMappingTable")]
    partial class ADdUnitePriceInMappingTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ElProApp.Data.Models.Mappings.BuildingMaterialMapping", b =>
                {
                    ...
                    b.HasOne("ElProApp.Data.Models.Building", null)
                        .WithMany("Materials")
                    ...
                    b.HasOne("ElProApp.Data.Models.Material", null)
                        .WithMany("Buildings")
